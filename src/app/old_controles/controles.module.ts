...
import { TextMaskDirective } from '../directives/textMask/textmask.directive';
...
const COMPONENTS = [
  ...
  CustomselectComponent, TimepickerComponent, TextareaComponent,
  InputMaterialComponent, NumericMaterialComponent, DatepickerMaterialComponent,
  SelectMaterialComponent, CurrencyMaskDirective,
  TextMaskDirective, InputIPComponent
];
