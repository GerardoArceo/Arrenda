...
export class AltaGrupoConceptoComponent extends BaseComponent implements OnInit {
  ...
  setValidaciones(form: FormGroup){
    ...
    form.controls.gcgrupo.setValidators([Validators.required, Validaciones.maxLengthNumber(10)]);       
    form.controls.gcconcepto.setValidators([Validators.required, Validaciones.maxLengthNumber(4)]);
    form.controls.gcdescripcion.setValidators([Validators.required, Validaciones.maxLengthNumber(36)]);     
  }
